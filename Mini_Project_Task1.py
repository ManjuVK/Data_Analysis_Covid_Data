...
UK_first_wave = y1[1:229]
UK_second_wave = y1[230:626]
...
plt.plot(x1, y1, '--r')
#second wave
x1, y1 = [201.1,334.9 ], [-5.17, -2.86]
plt.plot(x1, y1, '--g')
x1, y1 = [334.9, 550.4], [-2.86, -2.30]
plt.plot(x1, y1, '--r')
plt.grid()
plt.show()
...
plt.plot(x1, y1, '--r')
#second wave
x1, y1 = [231.6, 351.6], [-5.11, -3.10]
plt.plot(x1, y1, '--g')
x1, y1 = [351.6, 550.4], [-3.10, -2.54]
plt.plot(x1, y1, '--r')
plt.grid()
plt.show()
...
plt.plot(x1, y1, '--r')
#second wave
x1, y1 = [122.8, 190.5], [-5.01, -3.99]
plt.plot(x1, y1, '--g')
x1, y1 = [190.5, 248.3], [-3.99, -3.63]
plt.plot(x1, y1, '--r')
# third wave
